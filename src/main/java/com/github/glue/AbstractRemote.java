...
public class AbstractRemote {
     ...
     * 添加对应的Controller
     *
     * @param controllerInstance 添加{@link com.github.glue.NettyServer.NettyConnectHandler}注解的类的实例
     ...
     * <p>
     * 注意：
     * 参数类需要有注解{@link com.github.glue.NettyServer.NettyConnectHandler}，否则没有用
     *
     ...
     * 添加对应的Controller
     *
     * @param controllerClass 添加{@link com.github.glue.NettyServer.NettyConnectHandler}注解的类
     * @param executorService 线程池
     */
